...
Usage:
    ...
    ./scripts/data/cif_to_protor_json.py /path/to/cif/files /path/to/output

    # Process single file
    ./scripts/data/cif_to_protor_json.py --file input.cif output.json.gz
"""
...
def generate(
    ...
    output_path: Annotated[
        Path | None,
        typer.Argument(help="Output directory (or file if --file)"),
    ] = None,
    file_mode: Annotated[
        bool,
    ...
    # Directory mode
    if output_path is None:
        console.print("[red]Error: Output directory required for directory mode[/red]")
        raise typer.Exit(1)
