...
**Observations:**
- At n_points=100, MDTraj native shows ~0.87% mean error vs n_points=960, while zsasa shows ~0.20% — difference is due to sphere point distribution (MDTraj uses Fibonacci spiral, zsasa uses a different algorithm)
