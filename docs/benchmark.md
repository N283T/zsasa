...
| Structure | Atoms | Threads | Zig (ms) | RustSASA (ms) | Zig Speedup |
|-----------|------:|--------:|---------:|--------------:|------------:|
| 1AON | 58,674 | 4 | 50.31 | 91.65 | 1.82x |
| 1AON | 58,674 | 10 | 41.37 | 87.26 | 2.11x |
| 4V6X | 106,846 | 4 | 82.67 | 154.70 | 1.87x |
| 4V6X | 106,846 | 10 | 64.19 | 146.51 | 2.28x |

**Summary**: シングルスレッドでは同等だが、マルチスレッドでは Zig が **1.8x-2.3x 高速**。RustSASA のスレッドスケーリングは限定的（t=1→10 で 1.4x）、Zig は良好にスケール（t=1→10 で 2.7x）。
