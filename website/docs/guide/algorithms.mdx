...
|----------|-------------------:|---------|
| Single file (100k+ atoms) | ~1.2x | [Single-file benchmarks](../benchmarks/single-file.md#runtime-and-memory) |
| Batch proteome processing | ~1.5–2x | [Batch benchmarks](../benchmarks/batch.md) |
| MD trajectory (33k atoms, 1k frames) | ~2.3x | [MD benchmarks](../benchmarks/md.md#throughput-summary) |
