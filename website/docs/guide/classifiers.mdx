...
# ProtOr
zsasa --classifier=protor structure.cif output.json

# OONS
zsasa --classifier=oons structure.cif output.json

# Custom config file
zsasa --config=my_radii.toml structure.cif output.json
```
...
```python
from zsasa import calculate_sasa, Classifier
