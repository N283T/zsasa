...
Usage:
    ./benchmarks/scripts/benchmark_sasa.py trajectory.xtc topology.pdb
    ./benchmarks/scripts/benchmark_sasa.py trajectory.xtc topology.pdb -t "1,4,8"
"""
...
def benchmark_mdsasa_bolt(xtc_path: Path, top_path: Path, n_runs: int = 3) -> dict | None:
